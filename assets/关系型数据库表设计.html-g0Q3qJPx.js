import{_ as l}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o as c,c as r,d as s,e as a,f as p,w as o,a as n}from"./app-2pke9_a8.js";const d="/assets/image-20240404103638709-dJITta2z.png",b="/assets/image-20240404103955415-Ah0w__8C.png",t="/assets/image-20240404110003096-EnOUM5rn.png",m={},f=n(`<h1 id="关系型数据库表设计" tabindex="-1"><a class="header-anchor" href="#关系型数据库表设计" aria-hidden="true">#</a> 关系型数据库表设计</h1><h2 id="一对一" tabindex="-1"><a class="header-anchor" href="#一对一" aria-hidden="true">#</a> 一对一</h2><p>主要是通过外键实现</p><p><strong>父表</strong>：被依赖/关联的表</p><p><strong>子表</strong>：设置外键的表</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="shiki one-dark-pro" style="background-color:#282c34;" tabindex="0"><code><span class="line"><span style="color:#abb2bf;">#用户表 User  父表</span></span>
